...
public class HttpResponseTesterTest
{
    ...
    public void testMultiHttp11Response() throws IOException
    {
        ...
        assertTrue(resp1.getContent().contains("ABCDEFGHIJKLMNOPQRSTTUVWXYZ\n"));
        ...
        assertTrue(resp2.getContent().contains("Host=Default\nResource=R1\n"));
        ...
        assertTrue(resp3.getContent().contains("Host=Default\nResource=R2\n"));
