...
public class HuffmanTest
{
    ...
    @MethodSource("data")
    public void testDecode(String specSection, String hex, String expected)
    {
    ...
    @ParameterizedTest(name="[{index}] spec={0}")
    @MethodSource("data")
    public void testDecodeTrailingFF(String specSection, String hex, String expected)
    {
        byte[] encoded=TypeUtil.fromHexString(hex+"FF");
        String decoded=Huffman.decode(ByteBuffer.wrap(encoded));
        assertEquals(expected,decoded,specSection);
    }
